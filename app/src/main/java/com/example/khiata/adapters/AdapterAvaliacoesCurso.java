...
public class AdapterAvaliacoesCurso extends RecyclerView.Adapter<AdapterAvaliacoesCurso.MeuViewHolder> {
    private List<Avaliation> avaliacoes = new ArrayList();
    private Context context;

    public AdapterAvaliacoesCurso(Context context, List<Avaliation> avaliacoes) {
    ...
    @NonNull
    @Override
    public AdapterAvaliacoesCurso.MeuViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        //Carregar o tempplate de visualização
        View viewItem = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_avaliacao_curso, parent, false);

        //Criar o ViewHolder para carregar os dados
        return new AdapterAvaliacoesCurso.MeuViewHolder(viewItem);
    }
